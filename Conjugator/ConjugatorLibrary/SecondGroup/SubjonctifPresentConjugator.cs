...
public static class SubjonctifPresentConjugator
{
    ...
    public static string[] GetConjugations(string verb)
    {
        ...
        if (verb.EndsWith("seoir"))
        {
            ...
            if (verb.EndsWith("asseoir")) return AddEndings(Endings, new ComplexStem(stem + "oi", stem + "oy"));

            return Endings.AddEndings(stem + "ié");
        }

        var complexStem = GetComplexStem(verb);
        if (complexStem != null) return AddEndings(Endings, complexStem);
    ...
    private static ComplexStem GetComplexStem(string verb)
    {
        ...
        if (verb == "vouloir") return new ComplexStem("veuill", "voul");
